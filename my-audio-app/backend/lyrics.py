...
# This function will be called by the Flask API
def transcribe(file_path):
    print(f"Transcribe function called with path: {file_path}")
    print(f"File exists: {os.path.exists(file_path)}")
    print(f"File size: {os.path.getsize(file_path) if os.path.exists(file_path) else 'N/A'}")
    return get_large_audio_transcription_on_silence(file_path)